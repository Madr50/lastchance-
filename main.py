...
async def _bot_main() -> None:
    ...
    from bot_handlers import (
        ...
        cmd_myinvites, cmd_competitions,
    ...
    bot_app.add_handler(CommandHandler("myinvites",    cmd_myinvites))
    bot_app.add_handler(CommandHandler("competitions", cmd_competitions))
